...
impl Vm{
    ...
    pub unsafe fn new_vm(code:&[u8], ra_stack_size: usize, stack_size: usize) -> Vm{
        ...
        Vm{exit_flag: false, memory: memory as *mut u64, ra: 0, bp: ra_stack as isize, sp: ra_stack as isize, pc: (stack_size + ra_stack) as isize, imm: 0, memory_size: total_size as u64}
    }
